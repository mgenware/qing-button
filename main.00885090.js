...
/**
     ...
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */function Ct(t){return(e,i)=>void 0!==i?((t,e,i)=>{e.constructor.createProperty(i,t)})(t,e,i):wt(t,e)}var Ht=function(t,e,i,s){var n,o=arguments.length,r=o<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,s);else for(var l=t.length-1;l>=0;l--)(n=t[l])&&(r=(o<3?n(r):o>3?n(e,i,r):n(e,i))||r);return o>3&&r&&Object.defineProperty(e,i,r),r};let Tt=class extends xt{constructor(){super(...arguments),this.disabled=!1,this.autofocus=!1,this.canSelect=!1,this.disableSelectedStyle=!1,this.href="",this.btnStyle="",this.selected=!1,this.buttonElement=null}static get styles(){return[n`
        :host {
    ...
    `}focus(){this.buttonElement&&this.buttonElement.focus()}handleClick(t){t.preventDefault(),t.stopImmediatePropagation(),this.href?window.location.href=this.href:(this.canSelect&&(this.selected=!this.selected),this.dispatchEvent(new CustomEvent("click")))}};Ht([Ct({type:Boolean,reflect:!0})],Tt.prototype,"disabled",void 0),Ht([Ct({type:Boolean,reflect:!0})],Tt.prototype,"autofocus",void 0),Ht([Ct({type:Boolean,reflect:!0})],Tt.prototype,"canSelect",void 0),Ht([Ct({type:Boolean,reflect:!0})],Tt.prototype,"disableSelectedStyle",void 0),Ht([Ct({type:String,reflect:!0})],Tt.prototype,"href",void 0),Ht([Ct({type:String,reflect:!0})],Tt.prototype,"btnStyle",void 0),Ht([Ct({type:Boolean,reflect:!0})],Tt.prototype,"selected",void 0),Tt=Ht([(t=>e=>"function"==typeof e?((t,e)=>(window.customElements.define(t,e),e))(t,e):((t,e)=>{const{kind:i,elements:s}=e;return{kind:i,elements:s,finisher(e){window.customElements.define(t,e)}}})(t,e))("qing-button")],Tt);const kt="theme-dark";class Nt extends xt{render(){return lt`
      <div id="main">
        <p>
    ...
    `}handleFocusClick(){this.shadowRoot.getElementById("btn").focus()}switchThemes(){const{classList:t}=this.shadowRoot.getElementById("main");t.contains(kt)?t.remove(kt):t.add(kt)}}Nt.styles=n`
  html {
    box-sizing: border-box;
  }
  *,
